					...
					<div className="relative">
						<div className="flex flex-col max-w-md align-center justify-between border border-solid border-gray-200 bg-white dark:bg-gray-800 rounded-xl p-6 transition-all duration-300 transform group-hover:blur  hover:!blur-none hover:scale-110">
							<div className="flex flex-col mb-6 space-y-5">
								...
								<p className="text-gray-700 dark:text-gray-200">”Terkait pembelajaran yang disampaikan oleh Sekolah Developer Indonesia itu jauh diluar bayangan saya, saya senang menemukan sekolah ini. Semoga istiqomah”</p>
							</div>
							<div className="flex items-center space-x-2 bg-gray-50 dark:bg-gray-900/60 dark:text-gray-200 px-6 pt-6 pb-5 rounded-b-xl">
								<div className="flex flex-col justify-center">
					...
					<div className="relative">
						<div className="flex flex-col max-w-md align-center justify-between border border-solid border-gray-200 bg-white dark:bg-gray-800 rounded-xl p-6 transition-all duration-300 transform group-hover:blur  hover:!blur-none hover:scale-110">
							<div className="flex flex-col mb-6 space-y-5">
								...
								<p className="text-gray-700 dark:text-gray-200">”Saya menemukan Sekolah Developer Indonesia ini seprti menemukan emas, benar-benar melebihi ekspektasi saya. Semoga benar-benar sesuai dengan minat anak saya”</p>
							</div>
							<div className="flex items-center space-x-2 bg-gray-50 dark:bg-gray-900/60 dark:text-gray-200 px-6 pt-6 pb-5 rounded-b-xl">
								<div className="flex flex-col justify-center">
					...
					<div className="relative">
						<div className="flex flex-col max-w-md align-center justify-between border border-solid border-gray-200 bg-white dark:bg-gray-800 rounded-xl p-6 transition-all duration-300 transform group-hover:blur hover:!blur-none hover:scale-110">
							<div className="flex flex-col mb-6 space-y-5">
								...
								<p className="text-gray-700 dark:text-gray-200">”Kami sebagai orang tua tidak salah memilih Sekolah Developer Indonesia untuk putra kami karena kurikulum Pendidikan IT yang sesuai harapan kami. Kurikulum yang relevan dengan industry IT”</p>
							</div>
							<div className="flex items-center space-x-2 bg-gray-50 dark:bg-gray-900/60 dark:text-gray-200 px-6 pt-6 pb-5 rounded-b-xl">
								<div className="flex flex-col justify-center">
