		...
		<section className="px-4 bg-gray-900">
			<div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
				<div className="flex flex-col justify-center">
					<h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none  md:text-5xl lg:text-6xl lg:text-left text-white text-center ">Generasi Revolusi Digital Dunia</h1>
					<p className="mb-8 text-lg font-normal lg:text-xl text-gray-400 lg:text-left text-center">
					...
					<div className="flex mx-auto lg:mx-0 flex-col space-y-4 sm:flex-row sm:space-y-0">
						<a
