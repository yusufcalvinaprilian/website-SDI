			...
			<div className="mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl lg:max-w-none">
					<div className="text-center space-y-4">
						...
						<p className="text-lg leading-8 text-gray-300">kurikulum relevan dengan industri, diajarkan oleh mentor expert berpengalaman, dan pembelajaran yang dinamis</p>
					</div>
					<dl className="mt-16 grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 lg:grid-cols-4 pb-6 lg:pb-12">
