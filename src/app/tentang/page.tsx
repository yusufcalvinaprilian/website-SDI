...
export default function TentangPage() {
	return (
		<section className="w-full min-h-screen mt-16 pt-16 bg-gray-900">
			<div>
				<h1 className="text-center text-4xl font-bold text-white">Tentang Kami</h1>
			</div>
			<div className="py-8 mt-10 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-1 gap-8 lg:gap-16">
				<div className="flex flex-col justify-center px-4">
					...
					<p className="mb-8 text-lg font-normal lg:text-xl text-gray-300">
			...
			<div className="py-8 px-4 mx-auto w-full lg:py-16 flex justify-center">
				<a href="#" className="flex flex-col items-center  border rounded-lg shadow lg:flex-row lg:max-w-full border-gray-700 bg-gray-700 hover:bg-gray-800">
					...
					<div className="flex flex-col justify-center p-4 leading-normal ms-6">
						<h5 className="mb-3 text-2xl font-bold tracking-tight text-white">PKBM SEKOLAH DEVELOPER INDONESIA</h5>
